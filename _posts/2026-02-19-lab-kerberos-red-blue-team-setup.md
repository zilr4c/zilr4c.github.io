---
title: "(1/3) Lab de Kerberos: Red Team vs Blue Team - Setup, Vulnerabilidades y Telemetría"
...
image:
  path: /assets/img/posts/kerberos-lab-setup/esquema-red.jpg
  alt: "Esquema del Laboratorio de Ciberseguridad (Purple Team)"
---
...
![alt text](../assets/img/posts/kerberos-lab-setup/descarga.png){: width="400" }
...
![alt text](../assets/img/posts/kerberos-lab-setup/inst2.png){: width="600" }
...
![alt text](../assets/img/posts/kerberos-lab-setup/pass.png){: width="600" }
...
![alt text](../assets/img/posts/kerberos-lab-setup/sesion.png){: width="300" }
...
![alt text](../assets/img/posts/kerberos-lab-setup/powershell.png){: width="300" }
...
hostname
```
![alt text](../assets/img/posts/kerberos-lab-setup/hostname.png)
...
```
![alt text](../assets/img/posts/kerberos-lab-setup/name.png)
...
hostname
```
![alt text](../assets/img/posts/kerberos-lab-setup/name2.png)
...
![alt text](../assets/img/posts/kerberos-lab-setup/ip.png)
...
![alt text](../assets/img/posts/kerberos-lab-setup/static_ip.png){: width="400" }
...
```
![alt text](../assets/img/posts/kerberos-lab-setup/inst-ad1.png)
...
![alt text](../assets/img/posts/kerberos-lab-setup/inst-ad2.png)
...
![alt text](../assets/img/posts/kerberos-lab-setup/domain.png)
...
![alt text](../assets/img/posts/kerberos-lab-setup/pass-ad.png)
...
![alt text](../assets/img/posts/kerberos-lab-setup/netbios.png)
...
![alt text](../assets/img/posts/kerberos-lab-setup/install-ad.png)

#### Iniciando sesión AD

Tras el reinicio, la pantalla de bloqueo mostrará el dominio seguido del usuario (**STOICUS\Administrator**).

![alt text](../assets/img/posts/kerberos-lab-setup/sesion-ad.png){: width="400" }
...
New-ADUser -Name "Scott Marketing" -SamAccountName "scott" -Description "Vulnerable a ataque de diccionarios" -Enabled $true -PasswordNeverExpires $true -AccountPassword (ConvertTo-SecureString "AR#Admin#" -AsPlainText -Force)
...
```
![alt text](../assets/img/posts/kerberos-lab-setup/ad-users.png)
...
![alt text](../assets/img/posts/kerberos-lab-setup/spn.png)
...
```
![alt text](../assets/img/posts/kerberos-lab-setup/spn2.png)
...
![alt text](../assets/img/posts/kerberos-lab-setup/sysmon.png)
...
![alt text](../assets/img/posts/kerberos-lab-setup/sysmon-event.png)
...
![alt text](../assets/img/posts/kerberos-lab-setup/image.png)
